...
static void test_echo_return_and_status(void)
{
	...
	MU_ASSERT_INT(0, capture_echo(&shell, 2, argv, buf, sizeof(buf)));
...
static void test_echo_no_args(void)
{
	...
	capture_echo(&shell, 1, argv, buf, sizeof(buf));
...
static void test_echo_single_word(void)
{
	...
	capture_echo(&shell, 2, argv, buf, sizeof(buf));
...
static void test_echo_multiple_words(void)
{
	...
	capture_echo(&shell, 4, argv, buf, sizeof(buf));
...
static void test_echo_n_suppresses_newline(void)
{
	...
	capture_echo(&shell, 3, argv, buf, sizeof(buf));
...
static void test_echo_n_multiple_words(void)
{
	...
	capture_echo(&shell, 5, argv, buf, sizeof(buf));
